            ...
            <form class="form form col-md-6 col-md-offset-3" style="margin-top:20px">
                <span class="alert alert-danger hide" role="alert">Invalid Username</span>
                    ...
                    <div class="form-group col-md-12 text-center">
                        ...
                        <label class="col-md-12" for="exampleInputEmail3">Logo</label>
                    </div>

                    <div class="form-group col-md-12">
                        <label class="sr-only" for="exampleInputEmail3">Diagnostic Name</label>
                        <input type="email" class="form-control input-lg" id="exampleInputEmail3" placeholder="Diagnostic Name">
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        <label class="sr-only" for="exampleInputEmail3">Established in</label>
                        <input type="email" class="form-control input-lg" id="exampleInputEmail3" placeholder="Established in">
                    </div>
                    <div class="form-group col-md-12">
